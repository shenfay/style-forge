...
function parseUrlParams(): UrlConfig {
  ...
  if (scene && ['food', 'ecommerce', 'saas', 'media', 'social', 'finance', 'content', 'landing'].includes(scene)) {
  ...
  if (template && ['home', 'detail', 'list', 'form', 'settings', 'result', 'profile', 'messages', 'pricing'].includes(template)) {
